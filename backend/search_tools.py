...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build label and look up lesson link
            label = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: title, course link, and all lesson numbers and titles. Use this for questions about course structure, syllabus, or what lessons a course contains.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
